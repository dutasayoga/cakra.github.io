...
$STATUS_PK =  mysqli_real_escape_string($conn,$_POST['STATUS_PK']);

if($_POST["NIPEG"] != '') {
   $query = "UPDATE person SET NAMA = '$NAMA', KDKRJ = '$KDKRJ', P_NILAI = '$P_NILAI', K_NILAI = '$K_NILAI', STATUS_PK = '$STATUS_PK' WHERE NIPEG = '$NIPEG'";
